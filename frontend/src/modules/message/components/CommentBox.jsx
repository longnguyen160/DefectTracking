...
import { FILE_BASE_URL, ICONS, MESSAGE_TYPE, DEFAULT_AVATAR } from '../../../utils/enums';
import {
  DropZoneStyled,
  Image,
  TextArea,
  ...
  render() {
    ...
    return (
      <ElementHeaderStyled padding={'0'} top margin={'0 0 15px 0'}>
        {
          !value &&
            <Image topNav src={user && user.profile && user.profile.avatarURL ? FILE_BASE_URL + user.profile.avatarURL : FILE_BASE_URL + DEFAULT_AVATAR} margin={'0 5px'}/>
        }
        <InputCommentStyled>
