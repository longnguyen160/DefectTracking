...
const NotificationDetails = props => {
  ...
  return (
    <ListTableBodyStyled
      ...
      onClick={() => handleOpenModal(notification.issue.id, notification.id)}
    >
      ...
      </ListTableBodyItemStyled>
      {
        ...
        :
          <ListTableBodyItemStyled issueName container>
            ...
            <TitleElementStyled padding={'5px 0'} fontSize={'12px'}>{moment(notification.createdAt).format('LLL')}</TitleElementStyled>
          </ListTableBodyItemStyled>
      }
